...
//        GUI.Label(textOutputRect, outputMessage);
	...
	public void RequestBanner(AdPosition pos,string androidId,string iOSId)
    {
		...
		this.bannerView = new BannerView(adUnitId, AdSize.Banner, pos);
	...
	public void RequestInterstitial(string androidId,string iOSID)
    {
        // These ad units are configured to always serve test ads.
        #if UNITY_EDITOR
        string adUnitId = "unused";
	...
	public  void RequestRewardBasedVideo(string androidId,string iOSID)
    {
        #if UNITY_EDITOR
        string adUnitId = "unused";
        #elif UNITY_ANDROID
    ...
    {
		GameObject.FindObjectOfType<EasyAds> ().ShowReward ();
